...
export interface AmmoRigidBodyLike {
    ...
    applyImpulse(impulse: AmmoVector3Like, relativePosition: AmmoVector3Like): void;
    getCenterOfMassPosition(): AmmoVector3Like;
}
export interface AmmoLike {
    btVector3: new (x: number, y: number, z: number) => AmmoVector3Like;
    ClosestRayResultCallback: new (from: AmmoVector3Like, to: AmmoVector3Like) => any;
    btRigidBody: {
        prototype: {
            upcast?(object: any): AmmoRigidBodyLike;
        };
    };
    castObject?(object: any, klass: unknown): AmmoRigidBodyLike;
    destroy(object: unknown): void;
}
export interface AmmoWorldLike {
    rayTest(from: AmmoVector3Like, to: AmmoVector3Like, callback: any): void;
}
